...
# create a new plot
s1 = figure(width=175, plot_height=175, title=None, toolbar_location=None)
s1.circle(x, y0, size=6, color="navy", alpha=0.5)

# create a new plot and share both ranges
s2 = figure(width=175, height=175, x_range=s1.x_range, y_range=s1.y_range, title=None, toolbar_location=None)
s2.triangle(x, y1, size=6, color="firebrick", alpha=0.5)

# create a new plot and share only one range
s3 = figure(width=175, height=175, x_range=s1.x_range, title=None, toolbar_location=None)
